...
export async function GuidesSection({ limit }: { limit?: number }) {
  const items = (await listGuides()).slice(0, limit ?? 99);
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-xl text-[17px] leading-7 text-fog">
              Keepers from X. We skip marketplace dumps and crypto-desk bait.
            </p>
          </div>
