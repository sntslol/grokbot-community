...
const guides: Guide[] = [
  ...
  },
  {
    ...
    collection: "templates",
    group: "builders",
    href: "https://x.ai/bot/WdKtVYWvxVEDmc7xp8zO2",
    source: "Dave",
    date: "2026-09-06",
    excerpt: "Owns skill inventory: find, dedupe, upload/update, weekly conflict review.",
  },
  {
    slug: "gardener",
    title: "Gardener",
    ...
    collection: "templates",
    group: "engineering",
    href: "https://x.ai/bot/oH3eR4YWtsljcz0W4HUBp",
    source: "Tyler",
    date: "2026-09-06",
    excerpt: "Dead-code weeds only. One open PR at a time. No refactors.",
  },
  {
    slug: "researchy",
    title: "Researchy",
    ...
    collection: "templates",
    group: "ops",
    href: "https://x.ai/bot/rQt4W2zO2Gx9lfcBjd1lj",
    source: "Farzad",
    date: "2026-09-06",
    excerpt: "Live-web research and fact-check. Sourced, dated claims.",
  },
  {
    slug: "growth-desk",
    title: "Growth Desk",
    ...
    collection: "templates",
    group: "ops",
    href: "https://x.ai/bot/YYCOE-YeGxnGLb4Mbv7dO",
    source: "Avid",
    date: "2026-09-06",
  ...
  },
  {
    ...
    collection: "templates",
    group: "builders",
    href: "https://x.ai/bot/p7Gh6HIrfv4AGzIow6-9X",
    source: "Skills Dojo",
    date: "2026-09-08",
    excerpt: "Org design for a Bot fleet. Clear owners. Never creates or changes without an exact yes.",
  },
  {
    slug: "app-store-review-bot",
    title: "App Store Review Bot",
    kind: "template",
    collection: "templates",
    group: "engineering",
    href: "https://x.ai/bot/KzBEylM_3NFTjATszLICV",
    source: "Steve Derico",
    date: "2026-09-08",
    excerpt: "iOS App Review specialist. Audits before submit. Guides rejection response.",
  },
  {
    slug: "overheard",
    title: "Overheard",
    ...
    collection: "templates",
    group: "ops",
    href: "https://x.ai/bot/NIEguoGUjA648fUPle8F5",
    source: "Lenny Rachitsky",
    date: "2026-09-08",
    excerpt: "Third-party mention desk. Weekday digest. Quiet on dead days. Never posts.",
  },
  {
    slug: "haggle-bot",
    title: "Haggle Bot",
    ...
    collection: "templates",
    group: "ops",
    href: "https://x.ai/bot/pwQ612YrX3R0eACnIMlom",
    source: "SpaceXAI",
    date: "2026-09-08",
